namespace atm_uygulamasi
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
                 ...
                 List<kartSahib> kartsahibi = new List<kartSahib>();
                kartsahibi.Add(new kartSahib("1525168291459817", 1771, "Ahmet", "Kaynak", 1000.75));
                kartsahibi.Add(new kartSahib("1525851937259428", 9122, "Mehmet", "Efeli", 875000.12));
                kartsahibi.Add(new kartSahib("1525489177462812", 8144, "Nur", "Bayram", 18000.05));
                kartsahibi.Add(new kartSahib("1525961305700981", 5757, "Zeliha", "Arkan", 50.00));
                kartsahibi.Add(new kartSahib("1525574495231733", 2080, "Merve", "Emin", 350.00));
               
                Console.WriteLine("ATM uygulamasına hoş geldiniz...");
                Console.WriteLine("Lütfen Kart Numaranızı Giriniz: ");
                string debitCardNum = "";
                kartSahib currentUser;
                ...
                while(true)
                {
                    try
                    {
                        ...
                        currentUser = kartsahibi.FirstOrDefault(a => a.getNum() == debitCardNum);
                        if(currentUser != null)                       
                            break;                       
                        else
                        {
        ...
        private static void balance(kartSahib currentUser)
        {
            try
            {
        ...
        private static void withdraw(kartSahib currentUser)
        {
        ...
        private static void deposit(kartSahib currentUser)
        {
            try
            {
